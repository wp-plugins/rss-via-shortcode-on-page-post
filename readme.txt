...
Simple plugin to show RSS feeds in any posts and/or pages. It is the simplest and best plugin for Amazon associate & eBay partner network product advertising.
...
**Where:**
1 **rss** = URL of your RSS feed. This is the only tag required.
1 **feeds** = Number of RSS items to be fetched from feed. Default is 10
1 **excerpt** = Extract feed summery? True or False. Default is true.
1 **target** = Default is '_blank'. By default it will open links in a new window/tab. 
...
1. Place `[rssonpage rss="Your Feed URL" feeds="Number of Feeds" excerpt="summery true/false" target="_blank|_self|_top|_anyname"]` in your page/post where you want to display RSS feeds.
...
Please post your questions in support forum here. We will be happy to resolve them.
